...
Events are stored in-memory keyed by query_id and can be consumed
by the Dashboard API (dashboard.py) for real-time visualization.
"""
...
class EventLogger:
    ...
    def log_query_received(self, query_id: str, query: str, level: str = "L1", session_id: str = None):
